 ...
 * @version 5.0 This code is from Chapter 10 of Data Structures and Abstractions
 * with Java 5/e
 */
public interface ListInterface<T> {
     ...
     * new entry.
     * @param newEntry The object to be added as a new entry.
     * @throws IndexOutOfBoundsException if either newPosition LT 1 or newPosition
     * GT getLength() + 1.
     */
